...
## Solution 
We were provided a file named **inject.bin**. The name of the challenge is a hint, the file is an encoded Rubber Ducky payload. We can use an [online tool](https://ducktoolkit.com/decoder/) to retrieve the original script. (All of the commonly used scripts failed to retrieve the payload because of the french keyboard layout!).
